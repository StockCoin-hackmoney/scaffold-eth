 ...
 * The short token of the pair will be swapped away and only the long token will be kept.
 */
contract CustomIntegrationUmaLong is CustomIntegrationUmaLongShortPair {
  constructor(IBabController _controller) CustomIntegrationUmaLongShortPair(_controller, false) {}
}
